...
> ℹ️ **Under the hood:** Based on **NordVPN Linux Client 5.0.0**
...
| `LAN_DISCOVERY` | off | `on` | Allow access to local network devices while killswitch is active. Alternative to `ALLOWLIST_SUBNET` for simple setups. |
